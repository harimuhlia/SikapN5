        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              @if (Auth()->user()->role == 'admin')
              <li class="nav-item">
                <a href="{{ route('datalevel.index') }}" class="nav-link {{ Request::is('datalevel')?'active':'' }}">
              ...
              @endif
              <li class="nav-item">
                <a href="{{ route('datajurusan.index') }}" class="nav-link {{ Request::is('datajurusan')?'active':'' }}">
                  <i class="fas fa-angle-right"></i>
                  <p>Data Jurusan</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            @if (Auth()->user()->role == 'pendidik' || Auth()->user()->role == 'tendik')
            <a href="#" class="nav-link">
              <i class="fas fa-edit"></i>
              <p>
                Tugas Tambahan
