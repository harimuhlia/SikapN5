    ...
    <div class="card-body">
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <td>{{ $item->email }}</td>
          <td>
            <a href="/users/edit/{{$item->id}}" class="btn btn-secondary btn-sm " title="Edit"><i class="fas fa-edit"></i> Edit</a>
            <a href="/users/delete/{{ $item->id }}" class="btn btn-danger btn-sm " title="Hapus"><i class="fas fa-trash-alt"></i> Hapus</a>
