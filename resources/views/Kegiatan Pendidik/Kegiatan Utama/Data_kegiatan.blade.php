...
<div class="card">
    ...
    <div class="card-header">
      ...
      @endif
      <h3 class="card-title"><i class="fas fa-clipboard-list"></i> Data Kegiatan Pendidik</h3>
      <div class="card-tools">
        <a href="#" class="btn btn-success btn-sm "><i class="fas fa-file-excel" title="Export Data"></i> Import Excel</a>
        <a href="{{ route('kegiatanpendidik.create') }}" class="btn btn-primary btn-sm "><i class="fas fa-plus" title="Tambah Data"></i> Tambah Data</a>
      </div>
      {{-- <div class="card-tools">
        <form action="/printpendidik" method="POST">
          @csrf
          ...
          <div class="form-group">
            <input type="text" name="penugasan" class="form-control" placeholder="Penugasan" id="">
          </div>
          <div class="form-group">
