...
route::group(['middleware' => ['auth','role:admin,pendidik,tendik,kepala sekolah']], function(){
...
route::group(['middleware' => ['auth'],'role:admin'], function(){
    ...
    Route::get('/users/edit/{id}', [ManageController::class, 'edit'])->name('userEdit');
...
route::group(['middleware' => ['auth','role:pendidik']], function(){
...
route::group(['middleware' => ['auth','role:pendidik,tendik']], function(){
...
route::group(['middleware' => ['auth','role:tendik']], function(){
...
route::group(['middleware' => ['auth','role:kepala sekolah']], function(){
